...
const DEFAULT_URI = process.env.BASE_URL ? `${process.env.BASE_URL.replace(/\/$/, '')}/jasenet/oma/` : undefined;
...
const UserScreen: FC<StackScreenProps<BottomTabParamList, 'User'>> = ({ navigation }) => {
  if (!DEFAULT_URI) {
    return (
      <Container>
